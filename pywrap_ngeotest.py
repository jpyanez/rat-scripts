...
'/generator/vtx/set 5000 WAVELENGTH 0\n'+\
...
parser.add_option("-g", "--geometry", default="geo/lsnoplusnative.geo",
                  dest = 'geo')
parser.add_option("-o", "--outdir", default = 'redo_geometry',
                  dest="outdir")
parser.add_option("-f", "--filename", default="pbombtest",
                  dest= "outname")
...
if __name__ == '__main__':
    ...
    outdir = '/home/jp/projects/snoplus/rundir/nativegeo_verification2/' + options.outdir
